...
Namespace CustomReportParameterType.Services
    Public Class CustomDataSerializer
        ...
        Public Function CanDeserialize(ByVal value As String, ByVal typeName As String, ByVal extensionProvider As Object) As Boolean
            Return typeName = GetType(CustomParameterType).FullName
        End Function

        Public Function CanSerialize(ByVal data As Object, ByVal extensionProvider As Object) As Boolean
            Return TypeOf data Is CustomParameterType
        End Function

        Public Function Deserialize(ByVal value As String, ByVal typeName As String, ByVal extensionProvider As Object) As Object
        ...
        Public Function Serialize(ByVal data As Object, ByVal extensionProvider As Object) As String
