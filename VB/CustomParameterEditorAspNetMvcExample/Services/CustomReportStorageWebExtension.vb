...
Imports CustomParameterEditorAspNetMvcExample.PredefinedReports
...
Namespace Services
    Public Class CustomReportStorageWebExtension
		...
		Public Overrides Sub SetData(ByVal report As XtraReport, ByVal url As String)
			...
			End If
			report.Extensions(DevExpress.XtraReports.Native.SerializationService.Guid) = CustomDataSerializer.Name
